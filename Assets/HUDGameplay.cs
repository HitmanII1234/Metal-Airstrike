...
public class HUDGameplay : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameManager.Instance != null)
        {
            ...
            {
                if (textoScore != null)
                    textoScore.text = "SCORE: " + GameManager.Instance.scoreJugador1;

                if (textoNivel != null)
                    textoNivel.text = "NIVEL: " + GameManager.Instance.rondaJugador1;

                if (textoScoreP2 != null)
                    textoScoreP2.text = "SCORE: " + GameManager.Instance.scoreJugador2;

                if (textoNivelP2 != null)
                    textoNivelP2.text = "NIVEL: " + GameManager.Instance.rondaJugador2;
            }
            else
            {
